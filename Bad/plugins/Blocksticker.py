...
__MODULE__ = "ꜱᴛɪᴄᴋᴇʀ ʙʟᴏᴄᴋ"
__HELP__ = """ 

## ꜱᴛɪᴄᴋᴇʀ ʙʟᴏᴄᴋ

» `/addblock` : ʀᴇᴘʟʏ ᴛᴏ ᴀ ꜱᴛɪᴄᴋᴇʀ ᴏʀ ᴘᴀꜱᴛᴇ ᴀ ᴘᴀᴄᴋ ʟɪɴᴋ ᴛᴏ ʙʟᴏᴄᴋ
» `/unblock` : ʀᴇᴘʟʏ ᴛᴏ ᴀ ꜱᴛɪᴄᴋᴇʀ ᴏʀ ᴘᴀᴄᴋ ʟɪɴᴋ ᴛᴏ ᴜɴʙʟᴏᴄᴋ
» `/unblockall` : ʀᴇᴍᴏᴠᴇ ᴀʟʟ ʙʟᴏᴄᴋᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ ᴀɴᴅ ᴘᴀᴄᴋꜱ
» `/stickerid` : ɢᴇᴛ ᴛʜᴇ ꜰɪʟᴇ ᴜɴɪǫᴜᴇ ɪᴅ ᴀɴᴅ ᴘᴀᴄᴋ ɪɴꜰᴏ ᴏꜰ ᴀ ꜱᴛɪᴄᴋᴇʀ
» `/listblocks` : ᴠɪᴇᴡ ᴀʟʟ ʙʟᴏᴄᴋᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ ᴀɴᴅ ᴘᴀᴄᴋꜱ

🔁 **ᴀᴜᴛᴏ ᴅᴇʟᴇᴛᴇ**:
ᴀᴜᴛᴏᴍᴀᴛɪᴄᴀʟʟʏ ᴅᴇʟᴇᴛᴇꜱ ᴀɴʏ ʙʟᴏᴄᴋᴇᴅ ꜱᴛɪᴄᴋᴇʀꜱ ɪɴ ɢʀᴏᴜᴘꜱ ᴀɴᴅ ᴡᴀʀɴꜱ ᴛʜᴇ ᴜꜱᴇʀ.

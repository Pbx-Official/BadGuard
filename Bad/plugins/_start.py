...
» `/ping` : ᴄʜᴇᴄᴋ ʙᴏᴛ ʀᴇsᴘᴏɴsᴇ ᴛɪᴍᴇ ᴀɴᴅ ᴜᴘᴛɪᴍᴇ.

» `/sudolist` : ᴄʜᴇᴄᴋ ᴀʟʟ ᴀᴄᴛɪᴠᴇ sᴜᴅᴏ ᴜꜱᴇʀꜱ.

» `/song` or `/video [ᴛʀᴀᴄᴋ ɴᴀᴍᴇ / ʏᴛ ʟɪɴᴋ]` : ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴʏ sᴏɴɢ ᴏʀ ᴠɪᴅᴇᴏ ɪɴ ᴍᴘ𝟹 ᴏʀ ᴍᴘ𝟺 ꜰᴏʀᴍᴀᴛꜱ ꜰʀᴏᴍ ʏᴏᴜᴛᴜʙᴇ.

❖ ᴘᴇʀꜰᴇᴄᴛ ꜰᴏʀ ɢᴇᴛᴛɪɴɢ ʏᴛ ᴛʀᴀᴄᴋꜱ ᴏɴ ᴛʜᴇ ɢᴏ.
"""

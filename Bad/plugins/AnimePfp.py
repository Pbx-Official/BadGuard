...
__MODULE__ = "ᴀɴɪᴍᴇ ᴘꜰᴘ"
__HELP__ = """
**<u>⚡ ᴀɴɪᴍᴇ ᴘꜰᴘ ᴄᴏᴍᴍᴀɴᴅꜱ</u>**

» `/pfp` or `/animepfp` - ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀɴɪᴍᴇ ᴘʀᴏꜰɪʟᴇ ᴘɪᴄꜱ.

**<u> ꜱᴜᴘᴘᴏʀᴛᴇᴅ ᴄᴀᴛᴇɢᴏʀɪᴇꜱ</u>**

• `neko`  – v1, v2, v3, v4 _(ꜱꜰᴡ + ɴꜱꜰᴡ)_
• `husbando` – ʙᴏʏ ᴘꜰᴘꜱ
• `kitsune` – ꜰᴏx ɢɪʀʟꜱ _(ꜱꜰᴡ)_
• `waifu` – ᴄᴜᴛᴇ ɢɪʀʟꜱ _(ꜱꜰᴡ + ɴꜱꜰᴡ)_
• `fox_girl` – ᴀɴɪᴍᴀʟ ᴛʏᴘᴇ ꜰᴇᴍᴀʟᴇꜱ _(ꜱꜰᴡ)_
• `marin_kitagawa` – ꜱᴘᴇᴄɪᴀʟ ᴘꜰᴘꜱ _(ꜱꜰᴡ)_
• `zero_two` – ꜰʀᴏᴍ ᴅᴀʀʟɪɴɢ ɪɴ ᴛʜᴇ ꜰʀᴀɴx _(ꜱꜰᴡ)_
• `random` – ʀᴀɴᴅᴏᴍ ᴀɴɪᴍᴇ ɪᴍᴀɢᴇꜱ _(ꜱꜰᴡ)_

• ꜱᴇɴᴅ ᴄᴏᴍᴍᴀɴᴅ ᴀʟᴏɴᴇ ᴏʀ ᴡɪᴛʜ ᴄᴀᴛᴇɢᴏʀʏ ɴᴀᴍᴇ ꜰᴏʀ ꜱᴘᴇᴄɪꜰɪᴄ ʀᴇꜱᴜʟᴛꜱ.
"""

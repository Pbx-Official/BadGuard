...
» `/bored` : ᴛʀʏ ᴛʜɪꜱ ɪꜰ ʏᴏᴜ'ʀᴇ ɢᴇᴛᴛɪɴɢ ʙᴏʀᴇᴅ
» `/dice` : ꜱᴇɴᴅ 🎲 ᴀɴᴅ ɢᴇᴛ ʏᴏᴜʀ ꜱᴄᴏʀᴇ
» `/dart` : ꜱᴇɴᴅ 🎯 ᴀɴᴅ ᴛʀʏ ʏᴏᴜʀ ʟᴜᴄᴋ
» `/basketball` : ꜱᴇɴᴅ 🏀 ᴀɴᴅ ᴛᴀᴋᴇ ᴀ ꜱʜᴏᴛ
» `/football` : ꜱᴇɴᴅ ⚽ ᴀɴᴅ ꜱᴄᴏʀᴇ ᴀ ɢᴏᴀʟ
» `/jackpot` : ꜱᴘɪɴ 🎰 ᴀɴᴅ ᴛʀʏ ʏᴏᴜʀ ʟᴜᴄᴋ
» `/bowling` : ꜱᴇɴᴅ 🎳 ᴀɴᴅ ꜱᴇᴇ ʏᴏᴜʀ ꜱᴛʀɪᴋᴇ
» `/neko` : ɢᴇᴛ ᴀ ʀᴀɴᴅᴏᴍ ɴᴇᴋᴏ ɪᴍᴀɢᴇ
» `/slap` : ʀᴇᴘʟʏ ᴛᴏ ꜱʟᴀᴘ ᴀ ᴜꜱᴇʀ 😵
» `/kiss` : ʀᴇᴘʟʏ ᴛᴏ ᴋɪꜱꜱ ꜱᴏᴍᴇᴏɴᴇ 😘
» `/tickle` : ᴛɪᴄᴋʟᴇ ʏᴏᴜʀ ꜰʀɪᴇɴᴅ 😂
» `/feed` : ɢᴇᴛ ʀᴀɴᴅᴏᴍ ꜰᴇᴇᴅ ɢɪꜰꜱ 🍱
» `/pat` : ɢɪᴠᴇ ᴀ ʟɪᴛᴛʟᴇ ᴘᴀᴛ 🙃
» `/lizard` : ꜱᴇɴᴅꜱ ʀᴀɴᴅᴏᴍ ʟɪᴢᴀʀᴅ ɪᴍᴀɢᴇꜱ 🦎
» `/hug` : ꜱᴇɴᴅ ᴀ ʜᴜɢ ᴛᴏ ꜱᴏᴍᴇᴏɴᴇ 💞

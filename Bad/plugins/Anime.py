...
__MODULE__ = "ᴀɴɪᴍᴇ"
__HELP__ = """
**<u>❣️ ᴀɴɪᴍᴇ ᴄᴏᴍᴍᴀɴᴅꜱ</u>**

» `/anime <name>` - ɢᴇᴛ ᴀɴɪᴍᴇ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ.
» `/manga <name>` - ɢᴇᴛ ᴍᴀɴɢᴀ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ.
» `/character <name>` - ꜰɪɴᴅ ᴄʜᴀʀᴀᴄᴛᴇʀ ᴅᴇᴛᴀɪʟꜱ.
» `/airing <name>` - ɢᴇᴛ ɴᴇxᴛ ᴀɪʀɪɴɢ ᴛɪᴍᴇ & ᴇᴘɪꜱᴏᴅᴇ ᴜᴘᴅᴀᴛᴇꜱ.

• ᴀʟʟ ᴄᴏᴍᴍᴀɴᴅꜱ ᴡᴏʀᴋ ᴡɪᴛʜ ᴠᴀʟɪᴅ ᴀɴɪᴍᴇ/ᴍᴀɴɢᴀ ɴᴀᴍᴇꜱ.
• ᴜꜱᴇ ꜰᴜʟʟ ɴᴀᴍᴇꜱ ꜰᴏʀ ʙᴇᴛᴛᴇʀ ʀᴇꜱᴜʟᴛꜱ.
"""

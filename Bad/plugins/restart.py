...
from Bad.utils.pastebin import BadBin  # Make sure function name is BadBin not AviaxBin
...
async def log_(client, message, _):
    try:
        ...
        await message.reply_text("❖ ғᴀɪʟᴇᴅ ᴛᴏ ɢᴇᴛ ʟᴏɢs.")
    ...
    if await is_heroku():
        try:
            ...
            return await app.send_message(
                ...
                text=f"❖ sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ, ᴄʜᴇᴄᴋ ʟᴏɢs: {err}",
            )
    else:
